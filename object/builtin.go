...
//}
//
//func (b *Builtin) random(args []Object) Object {
//	if len(args) != 1 {
//		return newError("wrong number of arguments. random() got=%d, want=2", len(args))
//	}
//	max := args[0].(*Integer).Value
//	r, ok := rand.Int(rand.Reader, big.NewInt(max))
//	if ok != nil {
//		return newError("error occurred while calling 'rand(%v)': %s", max, ok.Error())
//	}
//	return &Integer{Value: r.Int64()}
//}
//
